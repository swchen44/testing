...
| P1 | `framework-skill-create-flow` skill | 互動式引導建立符合規範的 Skill（SKILL.md + README.md）| SKILL.md 模板定稿 |
...
| F-13 | 1 | P1 | `framework-skill-create-flow` skill | 互動式引導建立符合規範的 Skill（SKILL.md + README.md）| F-02（SKILL.md 模板）|
